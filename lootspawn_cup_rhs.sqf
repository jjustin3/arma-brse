...
switch(_weaponR) do {
  case 0: {_myweapon = "rhs_weap_mk18_m320";};
  case 1: {_myweapon = "rhs_weap_mk18_eotech_sup";};
  case 2: {_myweapon = "arifle_Katiba_C_ACO_pointer_F";};
  case 3: {_myweapon = "arifle_Mk20C_ACO_pointer_F";};
  case 4: {_myweapon = "arifle_TRG21_ACO_pointer_F";};
  case 5: {_myweapon = "arifle_MX_GL_Hamr_pointer_F";};
  ...
  case 16: {_myweapon = "CUP_arifle_AK107_kobra";};
  case 17: {_myweapon = "CUP_arifle_AK47";};
  case 18: {_myweapon = "CUP_arifle_AKS_Gold";};
  ...
  case 33: {_myweapon = "CUP_arifle_CZ805_A1_Aco_Laser";};
  case 34: {_myweapon = "CUP_arifle_CZ805_A2";};
  case 35: {_myweapon = "CUP_arifle_CZ805B_GL_ACOG_Laser";};
  case 36: {_myweapon = "CUP_arifle_FNFAL_ANPVS4";};
  case 37: {_myweapon = "CUP_arifle_G36C_holo_snds";};
  case 38: {_myweapon = "CUP_arifle_L85A2_Holo_laser";};
  case 39: {_myweapon = "CUP_arifle_L86A2_ACOG";};
  case 40: {_myweapon = "CUP_arifle_M4A3_desert_GL_ACOG_Laser";};
  case 41: {_myweapon = "CUP_arifle_Mk16_CQC_SFG_Holo";};
  case 42: {_myweapon = "CUP_arifle_Mk17_CQC_SFG_woodland";};
  case 43: {_myweapon = "CUP_arifle_Mk20_SB11420_snds";};
  case 44: {_myweapon = "CUP_arifle_XM8_Railed_ANPAS13c1_Laser";};
  case 45: {_myweapon = "rhs_weap_M590_8RD";};
  case 46: {_myweapon = "CUP_sgun_AA12";};
  case 47: {_myweapon = "CUP_sgun_M1014";};
  case 48: {_myweapon = "CUP_sgun_Saiga12K";};
  case 49: {_myweapon = "rhs_weap_pm63";};
  case 50: {_myweapon = "CUP_arifle_RPK74M";};
  case 51: {_myweapon = "CUP_arifle_RPK74";};
  case 52: {_myweapon = "CUP_lmg_L110A1_Aim_Laser";};
  case 53: {_myweapon = "rhs_weap_m249_pip_S";};
  case 54: {_myweapon = "rhs_weap_pkp";};
  case 55: {_myweapon = "CUP_smg_MP5SD6";};
  case 56: {_myweapon = "CUP_smg_bizon_snds";};
  ...
  case 62: {_myweapon = "CUP_srifle_AS50_AMPAS13c2";};
  case 63: {_myweapon = "CUP_srifle_CZ750_SOS_bipod";};
  case 64: {_myweapon = "CUP_srifle_SVD_des_ghillie_pso";};
  case 65: {_myweapon = "CUP_srifle_ksvk_PSO3";};
  case 66: {_myweapon = "CUP_srifle_AWM_wdl_SBPMII";};
  case 67: {_myweapon = "CUP_srifle_CZ550";};
  case 68: {_myweapon = "CUP_srifle_M107_LeupoldVX3";};
  case 69: {_myweapon = "CUP_srifle_M14_DMR_LeupoldMk4";};
  case 70: {_myweapon = "CUP_srifle_LeeEnfield_rail";};
  case 71: {_myweapon = "srifle_EBR_MRCO_LP_BI_F";};
  default {};
};
if(_weaponR < 72) then {
...
switch(_pistolR) do {
  ...
  case 7: {_mypistol = "rhs_weap_M320";};
  case 8: {_mypistol = "rhs_weap_rsp30_red";};
  case 9: {_mypistol = "CUP_hgun_TaurusTracker455_gold";};
  case 10: {_mypistol = "CUP_hgun_MicroUzi";};
  case 11: {_mypistol = "CUP_hgun_glock17_flashlight";};
  case 12: {_mypistol = "CUP_hgun_Phantom_Flashlight";};
  default {};
};
if(_pistolR < 13) then {
...
switch(_backpackR) do {
  ...
  case 7: {_mybackpack = "rhsusf_assault_eagleaiii_ucp";};
  case 8: {_mybackpack = "rhsusf_falconii_mc";};
  case 9: {_mybackpack = "rhs_sidor";};
  case 10: {_mybackpack = "rhs_assault_umbts";};
  case 11: {_mybackpack = "CUP_B_Bergen_BAF";};
  case 12: {_mybackpack = "CUP_B_ACRPara_m95";};
  case 13: {_mybackpack = "CUP_B_AlicePack_Bedroll";};
  case 14: {_mybackpack = "CUP_B_GER_Pack_Flecktarn";};
  case 15: {_mybackpack = "CUP_B_HikingPack_Civ";};
  case 16: {_mybackpack = "CUP_B_RUS_Backpack";};
  case 17: {_mybackpack = "CUP_B_AssaultPack_Black";};
  case 18: {_mybackpack = "CUP_B_USPack_Black";};
  default {};
};
...
switch(_helmR) do {
  ...
  case 27: {_myitem = "G_Balaclava_blk";};
  case 27: {_myitem = "G_Bandanna_Aviator";};
  case 27: {_myitem = "G_Aviator";};
  case 27: {_myitem = "G_Lowprofile";};
  case 28: {_myitem = "G_Tactical_Black";};
  case 29: {_myitem = "G_Sport_Blackred";};
  case 30: {_myitem = "rhs_6b47";};
  case 31: {_myitem = "rhs_6b47_ess_bala";};
  case 32: {_myitem = "rhs_6b7_1m_bala2_emr";};
  case 33: {_myitem = "rhs_6b7_1m_ess_bala";};
  case 34: {_myitem = "rhsusf_ach_bare_des_headset";};
  case 35: {_myitem = "rhsusf_ach_bare_semi_headset";};
  case 36: {_myitem = "rhsusf_ach_bare_wood";};
  case 37: {_myitem = "rhs_altyn_novisor_ess_bala";};
  case 37: {_myitem = "rhs_altyn_visordown";};
  case 37: {_myitem = "rhs_beret_vdv1";};
  case 38: {_myitem = "rhs_beret_mp1";};
  case 39: {_myitem = "rhs_fieldcap_ml";};
  case 40: {_myitem = "rhsusf_opscore_aor2_pelt";};
  case 41: {_myitem = "rhsusf_opscore_fg";};
  case 42: {_myitem = "rhsusf_opscore_mc_cover_pelt";};
  case 43: {_myitem = "rhsusf_opscore_paint_pelt_nsw_cam";};
  case 44: {_myitem = "rhsusf_opscore_bk_pelt";};
  case 45: {_myitem = "rhsusf_hgu56p_mask_skull";};
  case 46: {_myitem = "rhsusf_hgu56p_usa";};
  case 47: {_myitem = "rhsusf_hgu56p_visor_mask_black";};
  case 48: {_myitem = "rhsusf_hgu56p_visor_pink";};
  case 49: {_myitem = "rhs_zsh7a_mike_alt";};
  case 50: {_myitem = "CUP_H_TKI_Lungee_02";};
  case 51: {_myitem = "CUP_H_TKI_Lungee_04";};
  case 52: {_myitem = "CUP_H_TKI_Lungee_Open_02";};
  case 53: {_myitem = "CUP_H_TKI_Lungee_Open_05";};
  case 54: {_myitem = "CUP_H_TKI_SkullCap_04";};
  case 55: {_myitem = "rhsusf_shemagh_od";};
  case 56: {_myitem = "rhsusf_shemagh_tan";};
  case 57: {_myitem = "rhsusf_shemagh2_tan";};
  case 58: {_myitem = "rhsusf_shemagh2_od";};
  case 59: {_myitem = "CUP_H_C_MAGA_01";};
};
if (_helmR < 60) then {
  _ammobox addItemCargo [_myitem,1];
};
